defmodule MtgExchangeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MtgExchangeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MtgExchangeWeb.Gettext, "errors", msg, opts)
    end
  end
