defmodule MtgExchange.Account do
  @moduledoc """
  The Account context.
  """
  ...
  alias MtgExchange.Account.{User, UserToken, UserNotifier}
  ...
  defp user_email_multi(user, email, context) do
    changeset =
      user
      |> User.name_changeset(%{name: email})
  ...
  """
  def deliver_user_update_name_instructions(%User{} = user, current_email, update_email_url_fun)
      when is_function(update_email_url_fun, 1) do
    {encoded_token, user_token} = UserToken.build_name_token(user, "change:#{current_email}")

    Repo.insert!(user_token)
    UserNotifier.deliver_update_name_instructions(user, update_email_url_fun.(encoded_token))
  end
