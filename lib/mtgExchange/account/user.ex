defmodule MtgExchange.Account.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :exchanges, MtgExchange.Models.Exchanges, foreign_key: :user1
    timestamps()
  end
  ...
  defp maybe_validate_unique_name(changeset, opts) do
    if Keyword.get(opts, :validate_name, true) do
      changeset
      |> unsafe_validate_unique(:name, MtgExchange.Repo)
  ...
  """
  def valid_password?(%MtgExchange.Account.User{hashed_password: hashed_password}, password)
