defmodule MtgExchangeWeb.UserAuthTest do
  use MtgExchangeWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias MtgExchange.Account
  alias MtgExchangeWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MtgExchangeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MtgExchangeWeb.Endpoint.subscribe(live_socket_id)
